  ...
  return (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger>
          <Info
            className="h-2 w-2 text-slate-900 inline-block ml-0 align-super font-bold"
            strokeWidth={2.5}
          />
        </TooltipTrigger>
        <TooltipContent className="bg-slate-800 text-white font-normal">
          <p>{content}</p>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
...
function SummaryInfo({ responses, interview }: SummaryProps) {
  ...
  return (
    <div className="h-screen z-[10] mx-2">
      {responses.length > 0 ? (
        <div className="bg-white rounded-[2rem] min-h-[120px] p-6 shadow-sm border border-slate-100">
          ...
          <div className="flex flex-col gap-1 my-2 mt-4 mx-2 p-4 rounded-[1.5rem] bg-slate-50 border border-slate-100 shadow-sm">
          ...
          <div className="flex flex-row gap-1 my-2 justify-center">
            <div className="flex flex-col">
              <div className="flex flex-col gap-1 my-2 mt-4 mx-2 p-3 rounded-[1.5rem] bg-slate-50 border border-slate-100 shadow-sm max-w-[400px]">
                ...
                <div className="flex items-center justify-center">
                  <p className="text-2xl font-semibold text-slate-900 w-fit p-1 px-2 bg-slate-100 rounded-xl">
                    {convertSecondstoMMSS(totalDuration / responses.length)}
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 mx-2 p-3 rounded-[1.5rem] bg-slate-50 border border-slate-100 shadow-sm max-w-[360px]">
                ...
                <p className="w-fit text-2xl font-semibold text-slate-900 p-1 px-2 bg-slate-100 rounded-xl">
                  {Math.round((completedInterviews / responses.length) * 10000) / 100}%
                </p>
              </div>
            </div>
            <div className="flex flex-col gap-1 my-2 mt-4 mx-2 p-4 rounded-[1.5rem] bg-slate-50 border border-slate-100 shadow-sm max-w-[360px]">
